...
export const API_ENDPOINTS = {
  ...
  AOI: {
    ...
    STATS: (id: string) => `/api/v1/aoi/${id}/stats`,
    ANALYSES: (id: string) => `/api/v1/aoi/${id}/analyses`,
    PUBLIC: '/api/v1/aoi/public',
    TAGS: '/api/v1/aoi/tags',
  },
  ANALYSIS: {
    COMPREHENSIVE: '/api/v2/analyze/comprehensive',
    HISTORICAL: '/api/v2/analyze/historical',
    RESULT: (id: string) => `/api/v2/analyze/result/${id}`,
    RESULTS: '/api/v2/analyze/results',
    DATA_AVAILABILITY: (aoiId: string) => `/api/v2/data-availability/${aoiId}`,
  ...
  ALERTS: {
    ...
    BY_AOI: (aoiId: string) => `/api/v1/alerts/aoi/${aoiId}`,
    VERIFY: '/api/v1/alerts/verify',
